...
/**
 * Colorscale based on a reverse dark version of a graph colorscale.  The darker
 ...
 *@version 1.0
 */
public class RevDarkGrayColorScale implements ColorScale { 
  /**
   ...
   */
  public Color at(float f) { f = 0.8f - f * 0.8f; return new Color(f,f,f); } }
