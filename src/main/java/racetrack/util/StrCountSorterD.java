 ...
 *@version 1.0
 */
public class StrCountSorterD implements Comparable<StrCountSorterD> {
  /**
   ...
   *@param d   count
   */
  public StrCountSorterD(String str, double d) { this.str = str; this.d = d; }
   ...
   */
  public int compareTo(StrCountSorterD other) {
